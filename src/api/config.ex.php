...
return [
    ...
    "files" => [
        "maxSize" => 10 * 1024 * 1024, // Вместо 10 - размер в мегабайтах
        "src" => "../../uploads/",
        ...
        "storageLimit" => 0 * 1024 * 1024 * 1024 // Вместо 0 - размер в гигабайтах
    ],
    "accounts" => [
    ...
    "meta" => [
        ...
        "version" => "3.25.02.12" // Тут может быть что угодно. Трогать не советую
    ],
    "short" => [
